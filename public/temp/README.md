...
<!-- user: pateljash77_db_user : pateljash77@123 #do not use special character in mongodb password it required special escape strings to handle in connection string-->
